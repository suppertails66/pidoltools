...
//const int tableBase = 0x580B - 0x4000;
const int tableBase = 0x83A4 - 0x4000;
//const int numOps = 0x20;
const int numOps = 0x69;
...
//        fileofs << "; script op " << as2bHex(opNum) << endl;
        fileofs << "; gamescr op " << as2bHex(opNum) << endl;
