#ifndef YUNA2LINEWRAPPER_H
#define YUNA2LINEWRAPPER_H
...
class Yuna2LineWrapper : public BlackT::TLineWrapper {
public:
  typedef std::map<int, int> CharSizeTable;

  Yuna2LineWrapper(BlackT::TStream& src__,
...
//  };
  ...
  const static int default_controlOpsEnd = 0x10;
