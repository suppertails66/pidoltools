#ifndef YUNA2TRANSLATIONSHEET_H
#define YUNA2TRANSLATIONSHEET_H
...
class Yuna2TranslationSheetEntry {
public:
  enum Type {
    type_none,
    type_string,
...
typedef std::vector<Yuna2TranslationSheetEntry>
  Yuna2TranslationSheetEntryCollection;

class Yuna2TranslationSheet {
protected:
  struct DictEntry {
...
public:
  ...
  const Yuna2TranslationSheetEntry& getStringEntryById(std::string id) const;
...
protected:
  ...
  Yuna2TranslationSheetEntryCollection entries;
  std::map<std::string, Yuna2TranslationSheetEntry> stringEntryMap;
